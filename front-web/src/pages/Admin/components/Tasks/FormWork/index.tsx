...
const FormWork = () => {
    ...
    const isEditing = workId !== 'create';
    const formTitle = isEditing ? 'Editar uma tarefa Work' : 'cadastrar uma tarefa work';
    ...
    const onSubmit = (data: FormState) => {
        makePrivateRequest({
            url: isEditing ? `/works/${workId}` : '/works',
